            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" id="firstName" class="form-control" v-model="formData.firstName" placeholder="Juan">
                </div>
                <div class="col-md-6">
                  <label for="lastName" class="form-label">Apellido</label>
                  <input type="text" id="lastName" class="form-control" v-model="formData.lastName" placeholder="Pérez">
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="number" id="experience" class="form-control" v-model.number="formData.experienceYears" placeholder="15">
              </div>
  
              <div class="mb-3">
                <label for="clinicName" class="form-label">Nombre de la clínica</label>
                <input type="text" id="clinicName" class="form-control" v-model="formData.clinicName" placeholder="Clínica Corazón Sano">
              </div>
  
              <div class="mb-3">
                <label for="location" class="form-label">Ubicación</label>
                <input type="text" id="location" class="form-control" v-model="formData.location" placeholder="San Salvador">
              </div>
            </div>
          </div>
          ...
          <div class="card shadow-sm mt-4 left-column-card">
            <div class="card-body">
              ...
              <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" role="switch" id="showRating" v-model="viewOptions.showRating">
              ...
              <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" role="switch" id="showExperience" v-model="viewOptions.showExperience">
              ...
              <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" role="switch" id="showHomeVisits" v-model="viewOptions.showHomeVisits">
              ...
              <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" role="switch" id="showClinicLocation" v-model="viewOptions.showClinicLocation">
          ...
          <div class="card shadow-sm right-column-card">
            ...
            <div class="card-body">
              ...
              <div class="tab-content" id="clinicTabContent">
                ...
                <!-- Pestaña Información -->
                <div class="tab-pane fade" :class="{ 'show active': activeTab === 'info' }" id="info-tab-pane" role="tabpanel" aria-labelledby="info-tab" tabindex="0">
                  <div class="section-container p-3 rounded mb-4">
                    ...
                    <label for="professionalBio" class="form-label visually-hidden">Biografía profesional</label>
                    <textarea 
                      id="professionalBio" 
                      class="form-control" 
                      rows="5" 
                  ...
                  <div class="section-container p-3 rounded mb-4">
                    ...
                    <div v-for="(edu, index) in formData.education" :key="index" class="d-flex align-items-center mb-2 dynamic-item-row">
                      <input 
                        type="text" 
                  ...
                  <div class="section-container p-3 rounded mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                      <span v-for="(spec, index) in formData.specialities" :key="index" class="badge bg-primary-soft text-primary specialty-tag">
                        {{ spec }}
                        <button class="btn-close btn-close-sm ms-1" @click="removeSpeciality(index)" :aria-label="`Eliminar especialidad ${spec}`"></button>
                      </span>
                    </div>
                  ...
                  <div class="section-container p-3 rounded">
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="tel" id="phone" class="form-control" v-model="formData.phone" placeholder="+503 7123-4567">
                      </div>
                      <div class="col-md-6 mb-3">
                        <label for="email" class="form-label">Correo electrónico</label>
                        <input type="email" id="email" class="form-control" v-model="formData.email" placeholder="dr.juanperez@salusnexus.com">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <!-- Pestaña Horarios -->
                <div class="tab-pane fade" :class="{ 'show active': activeTab === 'schedule' }" id="schedule-tab-pane" role="tabpanel" aria-labelledby="schedule-tab" tabindex="0">
                  <div class="section-container p-3 rounded">
                    <h6 class="section-subtitle mb-3">
                    ...
                    >
                      ...
                      <div class="col-6 col-sm-3">
                        <label :for="`startTime-${index}`" class="visually-hidden">Hora inicio {{day.name}}</label>
                        <input type="time" :id="`startTime-${index}`" class="form-control form-control-sm time-input" v-model="day.startTime" :disabled="!day.isOpen">
                      </div>
                      <div class="col-auto time-separator">a</div>
                      <div class="col-6 col-sm-3">
                        <label :for="`endTime-${index}`" class="visually-hidden">Hora fin {{day.name}}</label>
                         <input type="time" :id="`endTime-${index}`" class="form-control form-control-sm time-input" v-model="day.endTime" :disabled="!day.isOpen">
                      </div>
                      <div class="col-12 col-sm-auto ms-sm-auto mt-2 mt-sm-0">
                        <div class="form-check form-switch d-flex justify-content-end">
                          <input class="form-check-input" type="checkbox" role="switch" :id="`isOpen-${index}`" v-model="day.isOpen">
                          <label class="form-check-label ms-2" :for="`isOpen-${index}`">{{ day.isOpen ? 'Abierto' : 'Cerrado' }}</label>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <!-- Pestaña Servicios -->
                <div class="tab-pane fade" :class="{ 'show active': activeTab === 'services' }" id="services-tab-pane" role="tabpanel" aria-labelledby="services-tab" tabindex="0">
                   <h6 class="section-subtitle mb-3">
                       <i class="fas fa-heartbeat icon-secondary me-2"></i>Servicios ofrecidos
                    </h6>
                  
                  <!-- Lista de servicios -->
                  <div v-for="(service, index) in formData.services" :key="service.id || index" class="card mb-3 service-card-item">
                    <div class="card-body">
                      <div class="row">
                         <div class="col-md-6 mb-3">
                          <label :for="`serviceName-${index}`" class="form-label">Nombre del servicio</label>
                          <input type="text" :id="`serviceName-${index}`" class="form-control" v-model="service.name" placeholder="Ej: Consulta cardiológica">
                        </div>
                        <div class="col-md-4 mb-3">
                           <label :for="`servicePrice-${index}`" class="form-label">Precio ($)</label>
                           <input type="number" :id="`servicePrice-${index}`" class="form-control" v-model.number="service.price" placeholder="60">
                         </div>
                         <div class="col-md-2 d-flex align-items-end justify-content-end mb-3">
                           <button class="btn btn-sm btn-outline-danger" @click="removeService(index)" :aria-label="`Eliminar servicio ${service.name}`">
                      ...
                      <div class="mb-2">
                         ...
                         <textarea :id="`serviceDesc-${index}`" class="form-control" rows="2" v-model="service.description" placeholder="Descripción breve del servicio..."></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="section-container p-3 rounded home-visits-section" :class="{ 'disabled': !formData.homeVisitsEnabled }">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <h6 class="section-subtitle mb-0">
                        <i class="fas fa-home icon-success me-2"></i>Visitas a domicilio
                      </h6>
                      <div class="form-check form-switch">
                         <input class="form-check-input" type="checkbox" role="switch" id="enableHomeVisits" v-model="formData.homeVisitsEnabled">
                         <label class="form-check-label" for="enableHomeVisits">{{ formData.homeVisitsEnabled ? 'Activado' : 'Desactivado' }}</label>
                      </div>
                    </div>
                    <p class="text-muted small mb-3">Configura si ofreces consultas a domicilio y su precio.</p>
                    
                    <div class="row">
                       <div class="col-md-6 mb-3">
                        <label for="homeVisitPrice" class="form-label">Precio de visita a domicilio ($)</label>
                        <input type="number" id="homeVisitPrice" class="form-control" v-model.number="formData.homeVisitPrice" placeholder="100" :disabled="!formData.homeVisitsEnabled">
                      </div>
                      <div class="col-md-12">
                        <label for="homeVisitInfo" class="form-label">Información adicional (Opcional)</label>
                         <input type="text" id="homeVisitInfo" class="form-control" v-model="formData.homeVisitInfo" placeholder="Ej: Este precio debe incluir el costo de transporte y la consulta" :disabled="!formData.homeVisitsEnabled">
                      </div>
                    </div>
                  </div>
                </div>
