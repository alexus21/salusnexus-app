          ...
          <div class="row mt-4">
              ...
              <div class="card p-4 mb-4">
                <div class="d-flex align-items-center justify-content-center mb-3">
                  <div class="position-relative">
                    ...
                    <input type="file" ref="imageInput" @change="handleImageUpload" class="d-none" accept="image/*">
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu w-100">
                      <li><a class="dropdown-item" @click="selectEspecialidad('Cardiólogo')">Cardiólogo</a></li>
                      <li><a class="dropdown-item" @click="selectEspecialidad('Dermatólogo')">Dermatólogo</a></li>
                      <li><a class="dropdown-item" @click="selectEspecialidad('Pediatra')">Pediatra</a></li>
                      <li><a class="dropdown-item" @click="selectEspecialidad('Neurólogo')">Neurólogo</a></li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="card p-4">
                ...
                <div class="mb-3">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" v-model="clinicData.showExperience">
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" v-model="clinicData.showHomeCare">
                    </div>
                  </div>
                </div>
                ...
                <div v-if="activeTab === 'servicios'" class="mb-3">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" v-model="clinicData.showLocation">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-8">
              ...
              <div v-if="activeTab === 'servicios'" class="card p-4">
                <ServiciosTab :servicios="clinicData.servicios" :visitasDomicilio="clinicData.visitasDomicilio" 
